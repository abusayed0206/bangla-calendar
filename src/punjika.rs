...
use crate::constants::*;
use crate::calendar::*;
use crate::fonts::{get_cal_header_font, get_cal_nav_font, get_cal_weekday_font, get_cal_date_font, get_cal_sub_font};
...
fn draw_calendar(hdc: HDC, rect: &RECT) {
    unsafe {
        ...
        DrawTextW(hdc, &mut month_text, &mut month_rect, DT_CENTER | DT_SINGLELINE);
        ...
        DrawTextW(hdc, &mut prev_text, &mut prev_rect, DT_LEFT | DT_VCENTER | DT_SINGLELINE);
        ...
        DrawTextW(hdc, &mut next_text, &mut next_rect, DT_RIGHT | DT_VCENTER | DT_SINGLELINE);
        ...
        for (i, day) in weekday_short.iter().enumerate() {
            ...
            DrawTextW(hdc, &mut day_text, &mut day_rect, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
        }
        ...
        while day <= days_in_month {
            for col in 0..7 {
                ...
                if is_today {
                    ...
                    let rgn = CreateRoundRectRgn(cell_rect.left, cell_rect.top, cell_rect.right, cell_rect.bottom, 8, 8);
                ...
                DrawTextW(hdc, &mut day_vec, &mut text_rect, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
...
extern "system" fn calendar_wndproc(hwnd: HWND, message: u32, wparam: WPARAM, lparam: LPARAM) -> LRESULT {
    unsafe {
        match message {
            WM_PAINT => {
